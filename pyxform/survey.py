...
#                            matchobj.group(1))
    ...
    @staticmethod
    def from_xform(path=None, filelike_obj=None, warnings=None):
        '''
        ...
        :Example: Survey.from_xform('/path/to/xform.xml')
        '''
    ...
    @staticmethod
    def from_xls(path=None, filelike_obj=None, warnings=None):
        '''
        ...
        :Example: Survey.from_xls(xls_file)
        '''
    ...
    @staticmethod
    def from_csv(path=None, filelike_obj=None, warnings=None):
        '''
        ...
        :Example: Survey.from_csv('/path/to/csv.csv')
        '''
